...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _search_bar = __webpack_require__(159);
	
	var _search_bar2 = _interopRequireDefault(_search_bar);
	
	var _youtubeApiSearch = __webpack_require__(160);
	
	var _youtubeApiSearch2 = _interopRequireDefault(_youtubeApiSearch);
	
	var _video_list = __webpack_require__(174);
	
	var _video_list2 = _interopRequireDefault(_video_list);
	
	var _video_detail = __webpack_require__(176);
	...
	var API_KEY = "AIzaSyAU1YSi97Kjc8PvPKrdoowV5rDSoPe815U";
	...
	var App = function (_React$Component) {
	    ...
	    function App(props) {
	        ...
	        _this.videoSearch('Game of thrones');
	        return _this;
	    }
	    ...
	    _createClass(App, [{
	        ...
	        value: function videoSearch(term) {
	            ...
	            (0, _youtubeApiSearch2.default)({ key: API_KEY, term: term }, function (videos) {
	                _this2.setState({ videos: videos, selectedVideo: videos[0] }); //same as {videos:videos}
	            });
	        }
	    }, {
	        key: 'render',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SearchBar = function (_Component) {
	    ...
	    _createClass(SearchBar, [{
	        key: 'onSearchChange',
	        value: function onSearchChange(term) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('img', { src: IMG_SRC, alt: 'brand' }),
	                    'UTube'
	                ),
	                _react2.default.createElement(
	                    'form',
	                    { className: 'search-bar', onSubmit: function onSubmit(event) {
	                            return _this2.onSearchSubmit(event);
	                        } },
	                    ...
	                    _react2.default.createElement('button', { type: 'submit', className: 'fa fa-search', 'aria-hidden': 'true' })
	                )
	            );
	        }
	    }]);
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      ...
	      if ((typeof XMLHttpRequest !== 'undefined') || (typeof ActiveXObject !== 'undefined')) {
	        __webpack_require__(166)(resolve, reject, config);
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    ...
	    var urlIsSameOrigin = __webpack_require__(171);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _video_list_item = __webpack_require__(175);
	...
	var VideoList = function VideoList(props) {
	    var videoItems = props.videos.map(function (video) {
	        return _react2.default.createElement(_video_list_item2.default, { onVideoSelect: props.onVideoSelect, key: video.etag, video: video });
	    });
	    return _react2.default.createElement(
	        'div',
	        null,
	...
	var VideoDetail = function VideoDetail(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement("iframe", { className: "embed-responsive-item", src: embedUrl })
	        ),
	        _react2.default.createElement(
	            "div",
	            { className: "details" },
